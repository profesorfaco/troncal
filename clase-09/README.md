...
Le queda, entre otras cosas, ponerse en el lugar de otro para responder a las siguientes preguntas: ¿Qué información podría necesitar de mi quien esté evaluando la posibilidad de acompañarme, orientarme y evaluarme en el avance autónomo que exige Proyecto de Título? ¿Acaso necesitará mi foto de perfil y rumores de mi simpatía? ¿Un recuento de las veces que le he pedido ser mi Profesor o Profesora Guía? ¿Ver todas mis notas sin conocer razones detrás de ellas? ¿O quizá necesite visualizar otro tipo de información? ¿Qué tipo de información podría ser realmente relevante para apoyar *el mutuo acuerdo* entre Profesor(a) y estudiante?
