...
* **Visualización en Chart.js:** Considera dos (2) visualizaciones generadas con chart.js, cada una a desplegarse en su `<canvas></canvas>`. Esto vuelve sobre las clases más recientes.
* **Buscador y tabla dinámica:** Cierra con un buscador y su tabla, donde el buscador actúa como sistema de filtrado donde la tabla de datos reaccione en tiempo real ante la presencia o ausencia de los términos buscados. Esto vuelve sobre la segunda evaluación sumativa, resuelta individualmente.
...
3. `script.js` para la lógica de la visualización en Chart.js y el comportamiento del buscador y su tabla dinámica (puede ser uno o dos archivos, según acomode a su desarrollo).
