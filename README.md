...
El curso se imparte los días martes, de 15:00 a 18:15 hrs. en sala G-34

El curso comienza a las 15:00 hrs. del martes 10 de marzo y termina a las 18:15 hrs. del martes 23 de junio de 2025.
 
[Clase 01](https://github.com/profesorfaco/troncal/tree/main/clase-01) → 10 de marzo → Presentación del curso y datos en hojas de cálculo ✓

[Clase 02](https://github.com/profesorfaco/troncal/tree/main/clase-02) → 17 de marzo → Presentación de herramientas del curso: GitHub y más ✓ 
...
[Clase 04](https://github.com/profesorfaco/troncal/tree/main/clase-04) → 31 de marzo → **Trabajo grupal, con evaluación diagnóstica** → Presentación del trabajo sobre hitos en la historia de la visualización de datos e información. Encargo del segundo trabajo grupal  ✓
...
[Clase 14](https://github.com/profesorfaco/troncal/tree/main/clase-14) → 16 de junio → **Semana de trabajo autónomo** → Avance en el trabajo final

[Clase 15](https://github.com/profesorfaco/troncal/tree/main/clase-15) → 23 de junio → **Cierre de asignaturas obligatorias y electivas** → Entrega del trabajo final

- - - - 

### Calificaciones para el promedio final

Clase 05 → trabajo grupal → 20% de la nota final
